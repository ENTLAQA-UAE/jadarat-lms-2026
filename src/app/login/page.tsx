    ...
    return (
        <div className="min-h-screen w-full">
            <div className="grid lg:grid-cols-2">
                ...
                <div className="hidden bg-[#E6E9F4] lg:block">
                    <div className="relative flex h-full items-center justify-center overflow-hidden">
                        <div className="absolute right-0 top-1/2 h-64 w-64 -translate-y-1/2 translate-x-1/3 rounded-full bg-blue-500 blur-3xl" />
                        <div className="absolute bottom-0 left-0 h-64 w-64 translate-y-1/3 -translate-x-1/3 rounded-full bg-blue-500 blur-3xl" />
                        <Image
