...
function EnrollmentsDataTable({ Enrollments, currentPage, pageSize, count }: { Enrollments: EnrollmentsType[], currentPage: number, pageSize: number, count: number }) {
