...
function StudentsFilter() {
    ...
    const countryOptions = ['All Countries', ...(learnerOptions?.learner_countries ?? [])];
                        ...
                        <DropdownMenuContent align="end">
                            {countryOptions.map((option) => (
                                <DropdownMenuItem
                                    ...
                                    key={option}
                                    onClick={() => handleDebouncedFilterChange('learner_country', option === 'All Countries' ? null : option)}
                                >
                                    {option}
                                </DropdownMenuItem>
                            ))}
