...
export default async function TableComponent({ searchParams }: { searchParams: { page?: string, learner_name?: string, learner_department?: string, learner_group_name?: string, learner_country?: string } }) {
  ...
  let _learner_country = searchParams.learner_country ? searchParams.learner_country : null

  const learnersResponse = await getLearners(page, pageSize, { _learner_name, _learner_department, _learner_group_name, _learner_country });
